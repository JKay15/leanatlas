...
| `git` | Repository metadata checks in tests/contracts. | `scripts/bootstrap.sh`, `scripts/clean.sh`, `tests/contract/check_problem_template_state.py`, `tools/promote/promote.py` |
